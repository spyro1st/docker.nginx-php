...
RUN apt-get update -qq && \
    apt-get install -qqy unzip nginx mysql-client vim-tiny php5 php5-cli php5-common php5-curl php5-fpm php5-gd php5-imagick php5-mcrypt php5-memcache php5-mysqlnd graphicsmagick ssl-cert ssmtp && \
